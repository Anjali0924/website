...
$sql = "SELECT user_cart.kid , user_cart.id , user_cart.pid , product_details.name ,product_details.description, product_details.type , product_details.cost , product_details.img , user_cart.date , user_cart.quantity FROM product_details INNER JOIN user_cart ON user_cart.pid = product_details.pid WHERE id = ".$id."";
